...
def queryCases : List (String × Case) := [
  ...
  ("FromWhereExistsCorrelated", q FromWhereExistsCorrelated),
  ("FromWhereNotExists", q FromWhereNotExists),
  ("FromWhereNotInSubquery", q FromWhereNotInSubquery),
  ("FromWhereNotInValues", q FromWhereNotInValues),
  ("FromWhereNotInWithNull", q FromWhereNotInWithNull),
